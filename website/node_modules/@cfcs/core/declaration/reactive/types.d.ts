 ...
 * @category Reactive
 */
export declare type ReactiveState<Instance extends ReactiveSubscribe<object>> = Instance extends ReactiveObject<infer State> | ReactiveSubscribe<infer State> ? Omit<State, "subscribe" | "unsubscribe"> : never;
export {};
